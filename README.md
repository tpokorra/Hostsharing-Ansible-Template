...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-Template.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-Template
...
The option -i can be used to read this inventory file instead of the /etc/ansible/hosts file. We want to login with an SSH-Key. We run:
    ...
    $ ansible-playbook -i inventory.yml playbook-template.yml
